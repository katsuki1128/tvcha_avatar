...
const executeActionsForStatus1 = () => {
        ...
        <div class="flex flex-col items-center justify-center px-3 pt-3 pb-3 mx-auto">
            <div class="w-full bg-white rounded-lg shadow sm:max-w-3xl md:w-4/5 xl:p-0">
                <div class="p-3 space-y-4 md:space-y-6 sm:p-8">
                    <div>
                        <img class="w-full h-15 mr-2" src="/static/img/uretoru_logo.png" alt="logo" />
    ...
    stampWrapper.innerHTML = `
        <div id="stampListContainer" class="stampContainer">
            <div class="image-wrapper"><img class="image" src="/static/img/a1_2023_12.png" data-id="a1"></div>
            <div class="image-wrapper"><img class="image" src="/static/img/a2_2023_12.png" data-id="a2"></div>
            <div class="image-wrapper"><img class="image" src="/static/img/b1_2023_12.png" data-id="b1"></div>
            <div class="image-wrapper"><img class="image" src="/static/img/b2_2023_12.png" data-id="b2"></div>
            <div class="image-wrapper"><img class="image" src="/static/img/a3_2023_12.png" data-id="a3"></div>
            <div class="image-wrapper"><img class="image" src="/static/img/a4_2023_12.png" data-id="a4"></div>
            <div class="image-wrapper"><img class="image" src="/static/img/b3_2023_12.png" data-id="b3"></div>
            <div class="image-wrapper"><img class="image" src="/static/img/b4_2023_12.png" data-id="b4"></div>
        </div>
        `;
    ...
    stampCountWrapper.innerHTML = `
        ...
        <div class="flex flex-col items-center mt-2">
            <div class="my-2">
                <img src="static/img/station_logo.png" alt="logo" class="w-32 h-auto" />
            </div>
            <div>
...
const playSound = (id) => {
    const audioSet = {
        a1: 'static/sound/a1.mp3',
        a2: 'static/sound/a2.mp3',
        a3: 'static/sound/a3.mp3',
        a4: 'static/sound/a4.mp3',
        b1: 'static/sound/b1.mp3',
        b2: 'static/sound/b2.mp3',
        b3: 'static/sound/b3.mp3',
        b4: 'static/sound/b4.mp3',
    };
...
const displayImageInSlot = (id, circleSize) => {
    // 画像のsrcを組み立てる
    const src = `static/img/${id}_2023_12.png`;
